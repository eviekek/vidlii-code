<div id="recent_activity3" <? if ($Profile["recent_d"] == 0 && $Is_OWNER) : ?>class="hddn"<? endif ?> module="re_r">
    <div class="in_box ib_col">
        <div class="box_title">
            Recent Activity
            <? if ($Is_OWNER) : ?>
                <a href="javascript:void(0)" style="position: absolute;right:77px;top:3px;font-size:18px" onclick="$('#edit_ra').toggleClass('hddn')">Edit</a>
                <div style="float: right;position:relative;top:2.5px;word-spacing:-4px;cursor:pointer">
                    <img src="/img/uaa1.png" onclick="c_move_up('recent_activity3')"> <img src="/img/daa1.png" style="margin-right:2px" onclick="c_move_down('recent_activity3')"><img src="/img/laa1.png" onclick="move_hor('recent_activity3','recent_activity2')"> <img src="/img/raa0.png">
                </div>
            <? endif ?>
        </div>
        <? if ($Is_OWNER) : ?>
            <div class="ch_edit_info hddn" id="edit_ra" style="padding: 7px;margin-bottom: 14px">
        ...
        <table class="ra" id="ra_in" <? if (count($Recent_Activity) == 0) : ?>style="display:none"<? endif ?>>
