    ...
    <div class="prbx_hd nm_hd">
        ...
        <? if ($Is_OWNER) : ?>
            <div style="float: right;position:relative;top:2.5px;word-spacing:-4px;cursor:pointer">
                <img src="https://vidlii.kncdn.org/img/uaa1.png" onclick="c_move_up('cmt_r')"> <img src="https://vidlii.kncdn.org/img/daa1.png" style="margin-right:2px" onclick="c_move_down('cmt_r')"><img src="https://vidlii.kncdn.org/img/laa1.png" onclick="move_hor('cmt_r','cmt_l')"> <img src="https://vidlii.kncdn.org/img/raa0.png">
            </div>
