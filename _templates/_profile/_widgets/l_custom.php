<section class="<? if ($Profile["custom_d"] == 1 && $Is_OWNER) : ?>hddn<? endif ?>" id="cu_l" module="cu_l">
            ...
            <div style="float: right;position:relative;top:3px;word-spacing:-4px;cursor:pointer">
                <? if ($Is_OWNER) : ?>
                    <form action="/user/<?= $_USER->displayname ?>" method="POST" style="display:inline-block" onsubmit="document.getElementById('bbcodeval1').value = document.getElementById('bbtextarea1').value">
                        <div style="margin-right:10px;position:relative;bottom:3px" id="savebbcode1link">
                ...
                <? endif ?>
                <img src="https://vidlii.kncdn.org/img/uaa1.png" onclick="c_move_up('cu_l')"> <img src="https://vidlii.kncdn.org/img/daa1.png" style="margin-right:2px" onclick="c_move_down('cu_l')"><img src="https://vidlii.kncdn.org/img/laa0.png"> <img src="https://vidlii.kncdn.org/img/raa1.png" onclick="move_hor('cu_l','cu_r')">
            </div>
        <? endif ?>
    </div>
