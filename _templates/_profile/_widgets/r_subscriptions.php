    ...
    <div class="prbx_hd nm_hd">
        ...
        <? if ($Is_OWNER) : ?>
            <div style="float: right;position:relative;top:3px;word-spacing:-4px;cursor:pointer">
                <img src="https://www.vidlii.com/img/uaa1.png" onclick="c_move_up('su1_r')"> <img src="https://www.vidlii.com/img/daa1.png" style="margin-right:2px" onclick="c_move_down('su1_r')"><img src="https://www.vidlii.com/img/laa1.png" onclick="move_hor('su1_r','su1_l')"> <img src="https://www.vidlii.com/img/raa0.png">
            </div>
        <? endif ?>
        <? if ($Has_Subscribed) : ?>
