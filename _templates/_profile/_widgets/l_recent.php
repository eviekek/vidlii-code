<section id="recent_activity2" <? if ($Profile["recent_d"] == 1 && $Is_OWNER) : ?>class="hddn"<? endif ?> module="re_l">
    <div class="nm_box">
        ...
        <div class="prbx_in nm_in ra1" id="nm_ra">
            ...
            <table class="ra" id="ra_in2">
                <? if (count($Recent_Activity) > 0) : ?>
                    ...
                    <? endforeach ?>
                <? else : ?>
                    <div id="no_ra2" style="font-size: 18px; text-align: center; padding: 12px 10px 9px">No Recent Activity</div>
                <? endif ?>
            </table>
        </div>
    </div>
