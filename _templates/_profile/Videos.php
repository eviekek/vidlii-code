    ...
    <div class="nm_box">
        <div class="prbx_hd nm_hd">
            ...
            <div style="float:right">
                <a<? if (isset($_POST["search_input"])) : ?> class="hddn"<? endif ?> href="javascript:void(0)" onclick="$(this).toggleClass('hddn');$('#searcher').toggleClass('hddn');$('#search_input').focus()">Search Videos</a>
                <form action="/user/<?= $Profile["displayname"] ?>/videos" method="POST" <? if (!isset($_POST["search_input"])) : ?>class="hddn"<? endif ?> style="position:relative;bottom:1px" id="searcher">
