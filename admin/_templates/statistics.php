<div style="width:48%;margin-right:2%;float:left;">
    ...
    <div class="panel_box">
        <strong>Video Favorites Graph</strong>
        <script>
            var chart = AmCharts.makeChart("chartdiv5", {
                ...
                "dataProvider": [
                    <? foreach ($Video_Favorites as $Favorite) : ?>
                    {
                        "date": "<?= $Favorite["date"] ?>",
                        "value": <?= $Favorite["amount"] ?>
                    },
                    <? endforeach ?>
                ]
            });
...
<div style="width:50%;float:left;">
    <div class="panel_box" style="overflow-y:auto;max-height:450px">
        ...
        <script>
            var chart = AmCharts.makeChart("chartdiv", {
                ...
                "dataProvider": [
                    <? foreach ($Videos_Stats as $User) : ?>
                    {
                        "date": "<?= $User["uploaded_on"] ?>",
                        "value": <?= $User["amount"] ?>
                    },
                    <? endforeach ?>
                ]
    ...
    <div class="panel_box">
        <strong>Video Responses Graph</strong>
        <script>
            var chart = AmCharts.makeChart("chartdiv6", {
                ...
                "dataProvider": [
                    <? foreach ($Video_Responses as $Favorite) : ?>
                    {
                        "date": "<?= $Favorite["date"] ?>",
                        "value": <?= $Favorite["amount"] ?>
                    },
